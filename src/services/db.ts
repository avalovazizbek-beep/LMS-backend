...
export async function initDatabase() {
  ...
  // Admin "O'qituvchi hisoboti": meetinglar o'qituvchi bo'yicha sanaladi
  await execIgnoreDuplicate(`ALTER TABLE lms_meetings ADD INDEX idx_meetings_creator (created_by_user_id)`)
